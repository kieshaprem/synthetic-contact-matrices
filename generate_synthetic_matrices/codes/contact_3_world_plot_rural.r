...
countries = as.character(popRural$ratio_female$iso3c[popRural$ratio_female$iso3c %in% names(contact_all)]) 
# to reorder the countries by name (not ISO)


pdf(paste0('plots/contactmatrices2020_rural.pdf'),height=21*cm,width=13.8*cm)
